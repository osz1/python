...
class Cube:
    ...
    def _rot_x2(self, cw):  # óramutató járásával egyezik-e
        cc = [list(row) for row in self.position]
    ...
    def _rot_x3(self, cw):  # óramutató járásával egyezik-e
        cc = [list(row) for row in self.position]
    ...
    def _rot_y1(self, cw):  # óramutató járásával egyezik-e
        cc = [list(row) for row in self.position]
    ...
    def _rot_y2(self, cw):  # óramutató járásával egyezik-e
        cc = [list(row) for row in self.position]
    ...
    def _rot_y3(self, cw):  # óramutató járásával egyezik-e
        cc = [list(row) for row in self.position]
    ...
    def _rot_z1(self, cw):  # óramutató járásával egyezik-e
        cc = [list(row) for row in self.position]
    ...
    def _rot_z2(self, cw):  # óramutató járásával egyezik-e
        cc = [list(row) for row in self.position]
    ...
    def _rot_z3(self, cw):  # óramutató járásával egyezik-e
        cc = [list(row) for row in self.position]
        n1, n2, n3 = cc[3][0], cc[4][0], cc[5][0]
